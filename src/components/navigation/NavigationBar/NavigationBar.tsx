...
export default function NavigationBar({ links }: NavigationBarProps) {
  return (
    <div className="h-fit w-full">
      <nav className="font-default fixed top-0 flex h-48 w-full flex-col items-center justify-evenly border border-b border-l-0 border-r-0 border-t-0 font-mono text-black sm:h-16 sm:flex-row sm:justify-center dark:text-white">
        <ul
          role="menu"
