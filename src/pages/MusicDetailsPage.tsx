export default function MusicDetailsPage() {
  return <div>Music Details Page</div>;
}

{
  /* <template>
  <main :id="`${releaseId}-release`" class="font-default text-white">
    <section>
      ...
      <div class="w-4/5 mx-auto">
        <div
          class="mx-auto w-11/12 mb-4 md:w-1/2 md:float-left md:mr-8 md:mb-2"
        >
          <image-link
            target="_blank"
            rel="noreferrer"
